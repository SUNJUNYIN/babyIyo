...
public class FragmentEasyread extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		view = inflater.inflate(R.layout.fragment_easyread, container, false);
		return view;
	}
	...
	private void initViewpager() {
		...
		viewPagerTop = (ViewPager) view.findViewById(R.id.vp_easyread);
		tv_desc = (TextView) view.findViewById(R.id.image_desc);
		
		initViewPagerScroll(viewPagerTop);
		pointGroup = (LinearLayout) view.findViewById(R.id.linear_point_mian);
		...
		for (int i = 0; i <imageList.length; i++) {
			...
			//UrlToList.urlDisplayImage(vpUrl, image, getActivity());
